...
@section('content')
    <div class="div d-flex justify-content-center">
        <div class="card w-50">
        <h5 class="card-header text-bold">Add New Email</h5>
            ...
            <div class="row justify-content-center">
                ...
                <form action="/createemail" method="post">
                    ...
                    <div class="mb-3 col-auto d-flex">
                        <label for="email" class="col-form-label mr-2 w-25">Alamat Email</label>
                    ...
                    <div class="mb-3 col-auto d-flex">
                        <label for="kode_cabang" class="col-form-label mr-2 w-25">Cabang</label>
                    ...
                    <div class="mb-3 col-auto d-flex justify-content-center">
                          ...
                          <a class="btn btn-info" href="/viewEmails">Kembali ke List Email</a>
                    </div>
                </form>
            </div>
        </div>
