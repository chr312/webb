...
<script src="{{ asset('') }}AdminLTE-3.2.0/dist/js/pages/dashboard.js"></script>  --}}
    ...
    <script>
        ...
        function drawTable() {
            ...
            $('#sidebar4').addClass("active").css("font-weight", "bold");
         ...
         $('#myTable').DataTable().destroy();
            product = $('#myTable').DataTable({
                ...
                ajax: {
                    url: '{{url('read/datatable/managemember')}}',
        ...
        //update data
        function editaddressmember(id) {
            $.get("{{url('editaddressmember')}}/" + id, {}, function(data, status) {
                $("#exampleModalLabel").html('Edit Alamat Member')
                $("#page").html(data);
        ...
        function updatemember(id) {
            ...
            $.ajax({
                type: "post",
                url: "{{url('updateaddressmember')}}/" + id,
                data: {
                        "address": address,
